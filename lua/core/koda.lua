-- koda.nvim needs a `setup()` call with variant-specific color overrides
-- before each `:colorscheme koda-*`, since the plugin doesn't expose its
-- variants as separate colorscheme files. Ported from SalarAlo's config.
local M = {}
